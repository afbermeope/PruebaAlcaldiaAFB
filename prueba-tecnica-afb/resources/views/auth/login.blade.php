...
<div class="login-box" style="margin-left: -33%">
  <div class="login-logo">
    <a style="@import url('http://fonts.cdnfonts.com/css/century-gothic'); color:#ffffff; font-family: 'Century Gothic', sans-serif;  "><b>App</b> Backoffice</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
